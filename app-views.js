...
window.exportJahresbericht = function(saisonKey) {
  ...
  // CSS
  var css = [
    /* v54.28: keine Google-Fonts mehr (Datenschutz) — lokale Schriften */
    '*{box-sizing:border-box;margin:0;padding:0}',
    'body{font-family:"Segoe UI",Roboto,Arial,sans-serif;font-size:9.5pt;color:#1a1a1a;background:#fff}',
    ...
    '.cover h1{font-family:Georgia,serif;font-size:26pt;color:#d4a84b;line-height:1.1;margin-bottom:6px}',
    ...
    'h2.section{font-size:12pt;color:#1a3a0a;border-bottom:2px solid #d4a84b;padding-bottom:4px;margin:20px 0 10px;font-family:Georgia,serif}',
